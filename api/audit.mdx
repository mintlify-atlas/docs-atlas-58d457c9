---
title: "Audit Log API — Track All Restaurant System Actions"
sidebarTitle: "Audit"
description: "Query and write the audit trail of system actions — logins, orders, payments, reports — with IP addresses and timestamps. Restricted to admin role."
---
