...
sidebarTitle: "Menu"
description: "Endpoints to list, create, update, and delete menu products and categories. Image upload via multipart form to ImageKit. Public menu returns only available items."
---
