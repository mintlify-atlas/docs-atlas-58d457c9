---
title: "Users API — Manage Restaurant Staff Accounts"
sidebarTitle: "Users"
...
To change a user's password, include the `password` field in the request body. The controller will hash the new value before writing it.
