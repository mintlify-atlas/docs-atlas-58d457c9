---
title: "Tickets and Invoices API — Receipts and Facturas"
sidebarTitle: "Tickets & Invoices"
description: "Generate and retrieve sale tickets and tax invoices (facturas) linked to paid orders. All endpoints restricted to admin and cajero roles."
---
...
<ResponseField name="factura" type="object">
  ...
  <Expandable title="factura fields">
    ...
    <ResponseField name="codigo_control" type="string">Fiscal control code, if provided. `null` otherwise.</ResponseField>
    <ResponseField name="qr_url" type="string">QR verification URL, if provided. `null` otherwise.</ResponseField>
  </Expandable>
</ResponseField>
